...
<div class="container">
    ...
    <div class="row" style="width: 100%;">
        <div class="col-md-6 mx-auto" >
            <form action="{{ action('Admin\TweetsController@update', ['id' => $post_form->id]) }}" method="post" enctype="multipart/form-data">
                @if (count($errors) > 0)
                    <ul>
                ...
                <div class="form-group">
                    ...
                    <select name="pref" class="form-control">
                        <option value="{{ $post_form->pref }}">{{ $post_form->pref }}</option>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="text" value="{{ $post_form->text }}" style="height: 150px;">{{ $post_form->text }}</textarea>
                </div>
                <!-- 画像 -->
                <div class="form-group">
